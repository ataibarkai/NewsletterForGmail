...
public extension Gmail {
	...
	static func provider(withClientId clientId: String,	scope: String) throws -> ReactiveCocoaMoyaProvider<Gmail>{
		...
		return ReactiveCocoaMoyaProvider<Gmail>(requestClosure: requestClosure)
	}
}
